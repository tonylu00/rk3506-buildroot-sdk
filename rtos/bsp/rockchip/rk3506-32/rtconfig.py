...
if PLATFORM == 'gcc':
    ...
    DEVICE = ' -mcpu=cortex-a7 -mfloat-abi=hard -mfpu=vfpv4 -marm -ffast-math'
    ...
    CFLAGS += ' -DFIRMWARE_BASE={a} -DDRAM_SIZE={b} -DLINUX_RPMSG_BASE={c} -DLINUX_RPMSG_SIZE={d}'.format(a=PRMEM_BASE, b=PRMEM_SIZE, c=LINUX_RPMSG_BASE, d=LINUX_RPMSG_SIZE)
