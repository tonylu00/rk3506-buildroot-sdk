...
/******  Platform Exceptions Numbers ***************************************************/
  ...
  MBOX_BB1_IRQn             =  172,    /*!< MBOX1 Interrupt                */
  MBOX_BB2_IRQn             =  173,    /*!< MBOX2 Interrupt                */
  MBOX_BB3_IRQn             =  174,    /*!< MBOX3 Interrupt                */
  MBOX_BB4_IRQn             =  175,    /*!< MBOX4 Interrupt                */
  MBOX_BB5_IRQn             =  176,    /*!< MBOX5 Interrupt                */
  MBOX_BB6_IRQn             =  177,    /*!< MBOX6 Interrupt                */
  MBOX_BB7_IRQn             =  178,    /*!< MBOX7 Interrupt                */
  MBOX_BB8_IRQn             =  179,    /*!< MBOX8 Interrupt                */
  MBOX_BB9_IRQn             =  180,    /*!< MBOX9 Interrupt                */
  MBOX_BB10_IRQn            =  181,    /*!< MBOX10 Interrupt               */
  MBOX_BB11_IRQn            =  182,    /*!< MBOX11 Interrupt               */
  MBOX_BB12_IRQn            =  183,    /*!< MBOX12 Interrupt               */
  MBOX_BB13_IRQn            =  184,    /*!< MBOX13 Interrup                */
  GPIO0_IRQn                =  185,    /*!< GPIO0 Interrupt                */
  GPIO0_EXP_IRQn            =  186,    /*!< GPIO1 EXP Interrupt            */
  GPIO1_IRQn                =  189,    /*!< GPIO0 Interrupt                */
  GPIO1_EXP_IRQn            =  190,    /*!< GPIO1 EXP Interrupt            */
  GPIO2_IRQn                =  193,    /*!< GPIO0 Interrupt                */
  GPIO2_EXP_IRQn            =  194,    /*!< GPIO1 EXP Interrupt            */
  GPIO3_IRQn                =  197,    /*!< GPIO0 Interrupt                */
  GPIO3_EXP_IRQn            =  198,    /*!< GPIO1 EXP Interrupt            */
  GPIO4_IRQn                =  201,    /*!< GPIO0 Interrupt                */
  GPIO4_EXP_IRQn            =  202,    /*!< GPIO1 EXP Interrupt            */
